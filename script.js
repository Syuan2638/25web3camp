document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizQuestions = [
        ...
        { question: "一個古老的靈魂容器，本身只是一個普通的陶罐。但真正賦予它力量的，是只有其主人知道的、能召喚並約束靈魂的「真言」。如果主人死去，只要新的繼承者知道了這句「真言」，他就能用任何一個新的陶罐，重新召喚同一個靈魂。在這個比喻中，「陶罐」和「真言」的關係，最貼切的描述是？", options: ["它們是不可分割的一個整體，一旦陶罐破碎，真言也隨之失效。", "「陶罐」是可替換的「界面」，而「真言」是獨立於界面的、代表所有權的「根密鑰」。", "「真言」是一把特殊的鑰匙，它只能打開這個特定的「陶罐」。", "在這個組合中，「陶罐」本身的存在遠比那句「真言」更為重要。"], answer: 1 },
